...
pub mod i_attestation_verifier {
    ...
    pub static IATTESTATIONVERIFIER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl ::core::convert::From<VerifyWithSignatureCall> for IAttestationVerifierCalls {
