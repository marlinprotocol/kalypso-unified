...
pub mod uc {
    ...
    pub static UC_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static UC_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static UC_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M> ::core::fmt::Debug for UC<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(UC))
                .field(&self.address())
                .finish()
        }
    }
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for UC<M> {
