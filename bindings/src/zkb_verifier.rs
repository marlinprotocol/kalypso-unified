...
pub mod zkb_verifier {
    ...
    pub static ZKBVERIFIER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static ZKBVERIFIER_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static ZKBVERIFIER_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for ZkbVerifier<M> {
