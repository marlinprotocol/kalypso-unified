...
pub mod xor_verifier {
    ...
    pub static XORVERIFIER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static XORVERIFIER_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static XORVERIFIER_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for XorVerifier<M> {
