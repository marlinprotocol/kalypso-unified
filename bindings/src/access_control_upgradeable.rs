...
pub mod access_control_upgradeable {
    ...
    pub static ACCESSCONTROLUPGRADEABLE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl ::core::convert::From<::std::string::String> for AccessControlUpgradeableErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<AccessControlBadConfirmation> for AccessControlUpgradeableErrors {
        fn from(value: AccessControlBadConfirmation) -> Self {
            Self::AccessControlBadConfirmation(value)
        }
    }
    impl ::core::convert::From<AccessControlUnauthorizedAccount> for AccessControlUpgradeableErrors {
        fn from(value: AccessControlUnauthorizedAccount) -> Self {
            Self::AccessControlUnauthorizedAccount(value)
        }
    }
    impl ::core::convert::From<InvalidInitialization> for AccessControlUpgradeableErrors {
    ...
    impl ::ethers::contract::EthLogDecode for AccessControlUpgradeableEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = RoleAdminChangedFilter::decode_log(log) {
                return Ok(AccessControlUpgradeableEvents::RoleAdminChangedFilter(
                    decoded,
                ));
            }
    ...
    impl ::core::convert::From<RoleAdminChangedFilter> for AccessControlUpgradeableEvents {
